...
public class Blowfish {
	...
	private String encStr(String s, long l) {
		...
		return bytesToBinHex(abyte1, 0, 8)
				+ bytesToBinHex(abyte0, 0, abyte0.length);
	}
	...
	private static class BlowfishECB {
		...
		protected long encryptBlock(long l) {
			...
			int ai4[] = m_pbox;
			i ^= ai4[0];
			j ^= (ai[i >>> 24] + ai1[i >>> 16 & 0xff] ^ ai2[i >>> 8 & 0xff])
					+ ai3[i & 0xff] ^ ai4[1];
			i ^= (ai[j >>> 24] + ai1[j >>> 16 & 0xff] ^ ai2[j >>> 8 & 0xff])
					+ ai3[j & 0xff] ^ ai4[2];
			j ^= (ai[i >>> 24] + ai1[i >>> 16 & 0xff] ^ ai2[i >>> 8 & 0xff])
					+ ai3[i & 0xff] ^ ai4[3];
			i ^= (ai[j >>> 24] + ai1[j >>> 16 & 0xff] ^ ai2[j >>> 8 & 0xff])
		...
		protected long decryptBlock(long l) {
			...
			int j = Blowfish.longLo32(l);
			i ^= m_pbox[17];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[16];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[15];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[14];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[13];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[12];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[11];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[10];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[9];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[8];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[7];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[6];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[5];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[4];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[3];
			j ^= (m_sbox1[i >>> 24] + m_sbox2[i >>> 16 & 0xff] ^ m_sbox3[i >>> 8 & 0xff])
					+ m_sbox4[i & 0xff] ^ m_pbox[2];
			i ^= (m_sbox1[j >>> 24] + m_sbox2[j >>> 16 & 0xff] ^ m_sbox3[j >>> 8 & 0xff])
					+ m_sbox4[j & 0xff] ^ m_pbox[1];
	...
	private static int binHexToBytes(String s, byte abyte0[], int i, int j,
			int k) {
		int l = s.length();
		int i1 = l - i >> 1;
		if (i1 < k)
	...
	private static String byteArrayToUNCString(byte abyte0[], int i, int j) {
		...
		for (; j > 0; j -= 2) {
			stringbuffer.setCharAt(l++,
					(char) (abyte0[i] << 8 | abyte0[i + 1] & 0xff));
			i += 2;
		}
